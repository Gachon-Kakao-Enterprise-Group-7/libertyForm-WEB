...
function SenderHistory(props) {
    ...
    return (
        <div>
            ...
            <PreviewTitle><h4>설문 발송자 관리</h4></PreviewTitle>
                ...
                <Table sx={{ minWidth: 350, }} aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            ...
                            <StyledTableCell align='center' style={{ fontWeight: 'bold' }}>관계</StyledTableCell>
                            <StyledTableCell align='center' style={{ fontWeight: 'bold' }}>응답여부</StyledTableCell>
