    ...
    <Backgrounddiv>
      <CardWrapper initial={{ opacity: 0.5 }} animate={{ opacity: 1 }}>
        ...
        <CardBody>
          ...
          <CardFieldset>
            <CardInput placeholder="Confirm Password" type="password" onChange={onChange} name="checkPassword" value={checkPassword} required />
          </CardFieldset>
          ...
          <CardFieldset>
            <CardInput  placeholder="Name"  type="text" onChange={onChange}  name="name"  value={name}  required />
          </CardFieldset>
